...
const translations = {
  en: {
    ...
    updating: "Updating...",
    openUniversitiesForApplication: "Open Universities for Application",
    universitiesYouCanApply: "Universities you can apply to",
    myApplications: "My Applications",
    trackYourApplications: "Track your applications",
    noApplicationsMade: "You haven't made any applications yet",
    exploreUniversitiesStart: "You can start by exploring universities and applying",
    ...
    rejected: "Rejected",
    user: "User",
    nationalityNotSpecified: "Nationality not specified",
    tryAgain: "Try Again",
  ...
  ar: {
    ...
    applications: "طلباتي",
    openUniversity: "الجامعة المفتوحة",
    totalApplications: "إجمالي الطلبات",
    approved: "موافق عليه",
    recentApplications: "الطلبات الأخيرة",
    featuredUniversities: "الجامعات المميزة",
    noApplicationsYet: "لا توجد طلبات بعد",
    noUniversitiesYet: "لا توجد جامعات بعد",
    ...
    openUniversitiesForApplication: "الجامعات المفتوحة للتقديم",
    universitiesYouCanApply: "الجامعات التي يمكنك التقديم إليها",
    myApplications: "طلباتي",
    trackYourApplications: "تتبع طلباتك",
    noApplicationsMade: "لم تقم بأي طلبات بعد",
    exploreUniversitiesStart: "يمكنك البدء باستكشاف الجامعات والتقديم",
    ...
    rejected: "مرفوض",
    user: "المستخدم",
    nationalityNotSpecified: "الجنسية غير محددة",
